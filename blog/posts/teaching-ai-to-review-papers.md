...
Peer review is overwhelmed. Conferences get thousands of submissions. Reviewers are volunteers squeezing reviews between their day jobs. The result is rushed reviews, inconsistent feedback, frustrated authors.
...
If you're doing any kind of repeated evaluation work like code reviews, application screening, or document analysis, the same skill architecture applies.
